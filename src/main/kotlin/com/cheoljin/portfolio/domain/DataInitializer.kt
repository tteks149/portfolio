package com.cheoljin.portfolio.domain
...
import com.cheoljin.portfolio.domain.entity.ExperienceDetail
...
import com.cheoljin.portfolio.domain.entity.ProjectDetail
import com.cheoljin.portfolio.domain.entity.ProjectSkill
import com.cheoljin.portfolio.domain.entity.Skill


import com.cheoljin.portfolio.domain.repository.AchievementRepository
import com.cheoljin.portfolio.domain.repository.ExperienceRepository
import com.cheoljin.portfolio.domain.repository.IntroductionRepository
import com.cheoljin.portfolio.domain.repository.LinkRepository
import com.cheoljin.portfolio.domain.repository.ProjectRepository
import com.cheoljin.portfolio.domain.repository.SkillRepository
...
@Component
@Profile(value = ["default"])  //   default or docker
class DataInitializer(
    ...
    @PostConstruct // 이 부분에서는 이미 모든 빈들이 생성되어 등록되어있음
    fun initializeData(){
